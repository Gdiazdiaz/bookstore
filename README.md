...
# 📖 Pokedex project <a name="about-project"></a>


**BOOKSTORE** is a project where we use React to build a Bookstore in a one-page website.
...
- **This project use React to display different pages**
...
- Go to this repo and copy the project link
        https://github.com/Gdiazdiaz/bookstore
- Open your terminal and clone the repo with this command "git clone https://github.com/Gdiazdiaz/bookstore.git"
...
- [ ] **It will allow to run functions such as edit book**
- [ ] **It will display several pages**
...
Feel free to check the [issues page](https://github.com/Gdiazdiaz/bookstore/issues).
